...
var G__1053 = new cljs.core.PersistentArrayMap(null, 5, [new cljs.core.Keyword(null,"report-counters","report-counters",-1702609242),new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"test","test",577538877),(0),new cljs.core.Keyword(null,"pass","pass",1574159993),(0),new cljs.core.Keyword(null,"fail","fail",1706214930),(0),new cljs.core.Keyword(null,"error","error",-978969032),(0)], null),new cljs.core.Keyword(null,"testing-vars","testing-vars",-2114769150),cljs.core.List.EMPTY,new cljs.core.Keyword(null,"testing-contexts","testing-contexts",-1485646523),cljs.core.List.EMPTY,new cljs.core.Keyword(null,"formatter","formatter",-483008823),cljs.core.pr_str,new cljs.core.Keyword(null,"reporter","reporter",-805360621),reporter], null);
if(cljs.core._EQ_.call(null,new cljs.core.Keyword("cljs.test","pprint","cljs.test/pprint",1627393641),reporter)){
return cljs.core.assoc.call(null,G__1053,new cljs.core.Keyword(null,"reporter","reporter",-805360621),new cljs.core.Keyword("cljs.test","default","cljs.test/default",-1581405322),new cljs.core.Keyword(null,"formatter","formatter",-483008823),cljs.pprint.pprint);
} else {
return G__1053;
}
});
...
var len__4411__auto___1058 = arguments.length;
var i__4412__auto___1059 = (0);
while(true){
if((i__4412__auto___1059 < len__4411__auto___1058)){
args__4414__auto__.push((arguments[i__4412__auto___1059]));

var G__1060 = (i__4412__auto___1059 + (1));
i__4412__auto___1059 = G__1060;
continue;
} else {
}
break;
...
cljs.test.update_current_env_BANG_.cljs$lang$applyTo = (function (seq1055){
...
return cljs.test.update_current_env_BANG_.cljs$core$IFn$_invoke$arity$variadic(G__1056,G__1057,seq1055__$2);
});
...
var file = cljs.core.get.call(null,map__1062__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
var line = cljs.core.get.call(null,map__1062__$1,new cljs.core.Keyword(null,"line","line",212345235));
var column = cljs.core.get.call(null,map__1062__$1,new cljs.core.Keyword(null,"column","column",2078222095));
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.reverse.call(null,cljs.core.map.call(null,((function (map__1062,map__1062__$1,file,line,column){
return (function (p1__1061_SHARP_){
return new cljs.core.Keyword(null,"name","name",1843675177).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,p1__1061_SHARP_));
});})(map__1062,map__1062__$1,file,line,column))
...
var temp__4657__auto___1064 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__4657__auto___1064)){
var message_1065 = temp__4657__auto___1064;
cljs.core.println.call(null,message_1065);
} else {
}
...
var temp__4657__auto___1066 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__4657__auto___1066)){
var message_1067 = temp__4657__auto___1066;
cljs.core.println.call(null,message_1067);
} else {
}
...
var output_dir = "out";
var output_dir__$1 = (function (){var G__1068 = output_dir;
if(!(clojure.string.ends_with_QMARK_.call(null,output_dir,"/"))){
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__1068),"/"].join('');
} else {
return G__1068;
}
})();
...
var G__1070 = exception.stack;
var G__1070__$1 = (((G__1070 == null))?null:clojure.string.split_lines.call(null,G__1070));
var G__1070__$2 = (((G__1070__$1 == null))?null:cljs.core.get.call(null,G__1070__$1,depth));
if((G__1070__$2 == null)){
return null;
} else {
return clojure.string.trim.call(null,G__1070__$2);
}
} else {
...
var vec__1071 = cljs.test.js_line_and_column.call(null,stack_element);
var line = cljs.core.nth.call(null,vec__1071,(0),null);
var column = cljs.core.nth.call(null,vec__1071,(1),null);
var vec__1074 = cljs.test.mapped_line_and_column.call(null,fname,line,column);
var fname__$1 = cljs.core.nth.call(null,vec__1074,(0),null);
var line__$1 = cljs.core.nth.call(null,vec__1074,(1),null);
var column__$1 = cljs.core.nth.call(null,vec__1074,(2),null);
...
var m__$1 = (function (){var G__1077 = new cljs.core.Keyword(null,"type","type",1174270348).cljs$core$IFn$_invoke$arity$1(m);
var G__1077__$1 = (((G__1077 instanceof cljs.core.Keyword))?G__1077.fqn:null);
switch (G__1077__$1) {
case "fail":
...
var G__1081 = (function (){var G__1080 = cljs.core.rest.call(null,fns);
...
return cljs.core.concat.call(null,obj,G__1080);
} else {
return G__1080;
}
})();
...
return cljs.core.vary_meta.call(null,G__1082,cljs.core.assoc,new cljs.core.Keyword("cljs.test","block?","cljs.test/block?",686379965),true);
}
});
...
}catch (e1083){var e = e1083;
var G__1084 = e;
var G__1084__$1 = (((G__1084 instanceof cljs.core.Keyword))?G__1084.fqn:null);
switch (G__1084__$1) {
...
var vec__1086 = fixtures_types.call(null);
var type = cljs.core.nth.call(null,vec__1086,(0),null);
var types = vec__1086;
...
return cljs.core.map.call(null,(function (p__1089){
var vec__1090 = p__1089;
var ns = cljs.core.nth.call(null,vec__1090,(0),null);
var vars__$1 = cljs.core.nth.call(null,vec__1090,(1),null);
return ((function (vec__1090,ns,vars__$1){
return (function (){
...
var G__1093 = cljs.test.execution_strategy.call(null,once_fixtures,each_fixtures);
var G__1093__$1 = (((G__1093 instanceof cljs.core.Keyword))?G__1093.fqn:null);
switch (G__1093__$1) {
case "async":
...
return new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [((function (each_fixture_fn,G__1093,G__1093__$1,env,once_fixtures,each_fixtures,vec__1090,ns,vars__$1){
return (function (){
return cljs.test.join_fixtures.call(null,once_fixtures).call(null,((function (each_fixture_fn,G__1093,G__1093__$1,env,once_fixtures,each_fixtures,vec__1090,ns,vars__$1){
return (function (){
var seq__1094 = cljs.core.seq.call(null,vars__$1);
var chunk__1095 = null;
var count__1096 = (0);
var i__1097 = (0);
while(true){
if((i__1097 < count__1096)){
var v = cljs.core._nth.call(null,chunk__1095,i__1097);
var temp__4657__auto___1099 = new cljs.core.Keyword(null,"test","test",577538877).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,v));
if(cljs.core.truth_(temp__4657__auto___1099)){
var t_1100 = temp__4657__auto___1099;
each_fixture_fn.call(null,((function (seq__1094,chunk__1095,count__1096,i__1097,t_1100,temp__4657__auto___1099,v,each_fixture_fn,G__1093,G__1093__$1,env,once_fixtures,each_fixtures,vec__1090,ns,vars__$1){
return (function (){
return cljs.test.run_block.call(null,cljs.test.test_var_block_STAR_.call(null,v,cljs.test.disable_async.call(null,t_1100)));
});})(seq__1094,chunk__1095,count__1096,i__1097,t_1100,temp__4657__auto___1099,v,each_fixture_fn,G__1093,G__1093__$1,env,once_fixtures,each_fixtures,vec__1090,ns,vars__$1))
);
} else {
}

var G__1101 = seq__1094;
var G__1102 = chunk__1095;
var G__1103 = count__1096;
var G__1104 = (i__1097 + (1));
seq__1094 = G__1101;
chunk__1095 = G__1102;
count__1096 = G__1103;
i__1097 = G__1104;
...
var temp__4657__auto__ = cljs.core.seq.call(null,seq__1094);
if(temp__4657__auto__){
var seq__1094__$1 = temp__4657__auto__;
if(cljs.core.chunked_seq_QMARK_.call(null,seq__1094__$1)){
var c__4231__auto__ = cljs.core.chunk_first.call(null,seq__1094__$1);
var G__1105 = cljs.core.chunk_rest.call(null,seq__1094__$1);
var G__1106 = c__4231__auto__;
var G__1107 = cljs.core.count.call(null,c__4231__auto__);
var G__1108 = (0);
seq__1094 = G__1105;
chunk__1095 = G__1106;
count__1096 = G__1107;
...
var v = cljs.core.first.call(null,seq__1094__$1);
var temp__4657__auto___1109__$1 = new cljs.core.Keyword(null,"test","test",577538877).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,v));
if(cljs.core.truth_(temp__4657__auto___1109__$1)){
var t_1110 = temp__4657__auto___1109__$1;
each_fixture_fn.call(null,((function (seq__1094,chunk__1095,count__1096,i__1097,t_1110,temp__4657__auto___1109__$1,v,seq__1094__$1,temp__4657__auto__,each_fixture_fn,G__1093,G__1093__$1,env,once_fixtures,each_fixtures,vec__1090,ns,vars__$1){
return (function (){
return cljs.test.run_block.call(null,cljs.test.test_var_block_STAR_.call(null,v,cljs.test.disable_async.call(null,t_1110)));
});})(seq__1094,chunk__1095,count__1096,i__1097,t_1110,temp__4657__auto___1109__$1,v,seq__1094__$1,temp__4657__auto__,each_fixture_fn,G__1093,G__1093__$1,env,once_fixtures,each_fixtures,vec__1090,ns,vars__$1))
);
} else {
}

var G__1111 = cljs.core.next.call(null,seq__1094__$1);
var G__1112 = null;
var G__1113 = (0);
var G__1114 = (0);
seq__1094 = G__1111;
...
});})(each_fixture_fn,G__1093,G__1093__$1,env,once_fixtures,each_fixtures,vec__1090,ns,vars__$1))
);
});})(each_fixture_fn,G__1093,G__1093__$1,env,once_fixtures,each_fixtures,vec__1090,ns,vars__$1))
], null);
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__1093__$1)].join('')));

}
})());
});
;})(vec__1090,ns,vars__$1))
